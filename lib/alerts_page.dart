  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: SafeArea(child: CustomScrollView(physics: const BouncingScrollPhysics(), slivers: [
      ...
      _SGroup(ctrl: _entryCtrl, interval: const Interval(.65, 1.0), children: [
        _SDivider(),
        _SNav(icon: Icons.lock_reset_outlined, iconColor: _sAmber, title: 'Change Password', onTap: () {}, titleColor: _sSlate),
        _SNav(icon: Icons.logout_outlined, iconColor: _sSlateMid, title: 'Sign Out', titleColor: _sSlate, onTap: () {}),
        _SDivider(),
...
class _SNav extends StatelessWidget {
  final IconData icon; final Color iconColor, titleColor; final String title; final VoidCallback onTap;
